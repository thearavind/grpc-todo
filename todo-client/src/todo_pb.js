...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.todo.deleteTodoParams.prototype.toObject = function(
    opt_includeInstance
  ) {
 ...
 * @return {!proto.todo.deleteTodoParams}
 */
proto.todo.deleteTodoParams.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.todo.deleteTodoParams.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.todo.todoObject.deserializeBinaryFromReader
        );
        msg.addTodos(value);
        break;
      default:
...
proto.todo.todoResponse.prototype.getTodosList = function() {
  return /** @type{!Array<!proto.todo.todoObject>} */ (jspb.Message.getRepeatedWrapperField(
    this,
